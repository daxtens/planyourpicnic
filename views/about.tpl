...
<p><strong>Curious about what's going on and how to use this?</strong> See our GovHack 2013 <a href="http://www.youtube.com/watch?v=L1Vlc226ruM">video entry</a>.</p>
...
<p>Plan Your Picnic is not endorsed or associated with the ACT Government in any way, and the ACT Government is not responsible for any errors in this application.</p>

%rebase bootstrap_base title="About", desc="About the Plan your Picnic project.", active="about"
